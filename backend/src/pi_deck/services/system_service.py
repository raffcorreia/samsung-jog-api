"""System-level controls: Pi shutdown.
...
On mock hardware the call is logged only — no actual shutdown is issued.
"""
...
class SystemService:
    ...
    async def shutdown(self) -> None:
        ...
        # Small delay so the HTTP 200 response reaches the client before the Pi halts.
