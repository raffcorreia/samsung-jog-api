...
- [Project Overview](project_overview.md) — CJ791 JOG emulator: 2-board Phase 7 design (Controller + HDMI DDC), Pi 2B, GPIO map, connectors, power budget all settled; Phase 13 UI shell complete
